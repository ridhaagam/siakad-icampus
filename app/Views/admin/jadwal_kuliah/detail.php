                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th width="350px" class="text-center">Dosen</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <option value="">Pilih Mata Kuliah</option>
                        <?php foreach ($matkul as $key => $value) { ?>
                            <option value="<?= $value['id_matkul']?>">Semester: <?= $value['smt']?> | <?= $value['smt']?> SKS | <?= $value['kode_matkul']?> | <?= $value['matkul']?></option>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                    <label>Waktu</label>
                        <input name="waktu" class="form-control" placeholder="Contoh: 07:00-08:40">
                    </div>
                    </select>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                    <label>Kuota</label>
                        <input name="kuota" class="form-control" placeholder="Contoh: 35">
                    </div>
        <div class="row">
            <div class="col-sm-6">     
            <div class="form-group">

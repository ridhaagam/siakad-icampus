          ...
          <div class="box-body">
            ...
            <div class="col-sm-6">
              <div class="form-group" id="only-number">
                ...
                <input name="nidn" value="<?= $dosen['nidn'] ?>" class="form-control" readonly>
              </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="jenkel" value="<?= $dosen['jenkel'] ?>" readonly class="form-control">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label>Email</label>
                <input name="email" value="<?= $dosen['email'] ?>" readonly class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label>Alamat</label>
                <input name="alamat" value="<?= $dosen['alamat'] ?>" class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="ttl" value="<?= $dosen['ttl'] ?>" readonly class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="pendidikan" value="<?= $dosen['pendidikan'] ?>" readonly class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="status_ikatan_kerja" value="<?= $dosen['status_ikatan_kerja'] ?>" readonly class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="jabatan_fungsional" value="<?= $dosen['jabatan_fungsional'] ?>" readonly class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input name="status_aktivitas" value="<?= $dosen['status_aktivitas'] ?>" readonly class="form-control">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group" id="only-number">
                ...
                <input name="no_hp" value="<?= $dosen['no_hp'] ?>" class="form-control" id="number">

    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <li class="active"><a href=<?= base_url('dsn/absen_kelas') ?>><i class="glyphicon glyphicon-book"></i> <span>Presensi Kuliah</span></a></li>
                ...
                <table class="table table-striped table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url('dsn/presensi/' . $value['id_jadwal_kuliah']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-calendar"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>

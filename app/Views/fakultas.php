    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <li class="active"><a href=<?= base_url('Fakultas') ?>><i class="glyphicon glyphicon-book"></i> <span>Fakultas</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href=<?= base_url('User') ?>><i class="fa fa-th"></i> <span>User</span></a></li>
          <li><a href=<?= base_url('Tahun_Akademik') ?>><i class="fa fa-th"></i> <span>Tahun Akademik</span></a></li>
          </ul>
        </li>
